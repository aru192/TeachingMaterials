...
COLORS = {
    0: "#2A1D67",  # 背景色
    1: "#ff3d3d", 2: "#3d3dff", 3: "#3dff3d", 4: "#ffff3d", 5:"#a03dff"  # ぷよの色
}
...
class MinimumPuyoGame:
    ...
    def load_images(self):
        ...
        推奨画像サイズ:40×40ピクセル
        """
        file_mapping = {1: "puyo_red.png", 2: "puyo_blue.png", 3: "puyo_green.png", 4: "puyo_yellow.png", 5: "puyo_purple.png"}
    ...
    def spawn_puyo(self):
        self.puyo_colors = [random.randint(1, 5), random.randint(1, 5)]
        self.puyo_x = 3
        self.puyo_y = 0
        self.rot_state = 0
        self.is_chaining = False
