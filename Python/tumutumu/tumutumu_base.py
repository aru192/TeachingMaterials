...
class TsumuGame(arcade.Window):
    ...
    def __init__(self):
        ...
        left_wall.center_y = (FIELD_BOTTOM + FIELD_TOP) / 2
        ...
        right_wall.center_y = (FIELD_BOTTOM + FIELD_TOP) / 2
        ...
        bottom_wall.center_x = (FIELD_LEFT + FIELD_RIGHT) / 2
